...
Route::middleware(['auth'])->group(function () {
    ...
    // Rutas de periodos y asignación de maestros
    ...
    Route::get('/periodos/{periodo}/asistencias-dias', [AsistenciaController::class, 'verDiasRegistrados'])->name('asistencias.dias');
