                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <!-- <a class="nav-link" href="{{ route('record') }}">Registro</a> Aréa de registro a cursos -->
                                    <!-- <a class="nav-link" href="layout-sidenav-light.html">Constancias Generador</a> Aréa de constancias -->
                                    <!--<a class="nav-link" href="{{ route('periodos.index') }}">Periodos</a> Aréa de periodos -->
                                    @auth
                                    @if(Auth::user()->rol === 0)
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <img src="/recursos/images/fondo/CURSO_DOCENTE_1.png" alt="imagen_fondo" class="img-fluid">
                        </div> 
                    </div>   
                </main>
